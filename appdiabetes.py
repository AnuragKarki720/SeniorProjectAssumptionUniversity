...
model_file_path = os.path.join(script_dir, "trainedmodel2015.joblib")
scaler_file_path = os.path.join(script_dir, "DiabetesScaler.joblib")
# Load the model
...
@app.route("/prediabetespred.html")
def prediabetespred():
    return render_template("prediabetespred.html")
