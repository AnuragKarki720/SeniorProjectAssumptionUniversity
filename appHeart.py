...
model_file_path = os.path.join(script_dir, "highestTestModelHeart.joblib")
scaler_file_path = os.path.join(script_dir, "HeartScaler.joblib")
# Load the models
...
def predict_heart():
    ...
    scaledInput = scalerpath.transform([list(user_input.values())])
